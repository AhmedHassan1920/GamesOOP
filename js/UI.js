export default class UI {
    constructor() {
        this.games = null;
        this.game = null;
        this.gamesRow = document.querySelector(".games-row");
        this.gameDetailsRow = document.querySelector(".game-details-row");
        ...
        this.faBars = document.querySelector(".bars");
        this.ulStyle = document.querySelector(".links ul");
        this.loader = document.querySelector('.load-container');
        this.gamecatigory = "mmorpg";
        this.gameID = null;
